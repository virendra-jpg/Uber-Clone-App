...
function RideSelector({ pickupCoordinates, dropoffCoordinates }) {
  ...
  useEffect(() => {
    fetch(
      `https://api.mapbox.com/directions/v5/mapbox/driving/${pickupCoordinates[0]},${pickupCoordinates[1]};${dropoffCoordinates[0]},${dropoffCoordinates[1]}?access_token=pk.eyJ1Ijoic29ua2FyaWEiLCJhIjoiY2xiNHZtc3hmMDBqazNuazJ6a21qZzU5aSJ9.Ib9QYZvWMdB9Ep7UYeA-Zg`
    )
      .then((res) => res.json())
      // .then(res => res.json())
      .then(data => {
